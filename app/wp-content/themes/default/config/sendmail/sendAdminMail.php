...
class SendAdminMail
{
    ...
    public function contact($data)
    {
        ...
        // 管理者宛メールの送付先
        $to = "info@willstyle.co.jp";
        // 管理者宛メールのタイトル
        $subject = "【Will Style Inc.】お問い合わせフォームへお問い合わせがありました。";
        $headers = [];
    ...
    public function entry($data)
    {
        ...
        // 管理者宛メールの送付先
        $to = "hr@willstyle.co.jp";
        // 管理者宛メールのタイトル
        $subject = "【Will Style Inc.】採用エントリーフォームへ応募がありました。";
        $headers = [];
    ...
    public function cancellation($data)
    {
        ...
        $to = "info@willstyle.co.jp";
        // 管理者宛メールのタイトル
        $subject = "【Will Style Inc.】解約申請フォームへ申込みがありました。";
        $headers = [];
