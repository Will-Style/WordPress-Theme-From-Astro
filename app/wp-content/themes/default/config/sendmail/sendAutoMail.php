...
class SendAutoMail
{
    ...
    public $from = "Will Style Inc. <info@willstyle.co.jp>";
    ...
    public function contact($to, $data)
    {
        ...
        // メールのタイトル
        $subject = "【Will Style Inc.】お問い合わせを受付いたしました。";
        $headers = [];
        // メールのFromアドレス
        $headers[] = "From: Will Style Inc. <info@willstyle.co.jp>";

        //// 返信先
        $headers[] = 'Reply-To: Will Style Inc. <info@willstyle.co.jp>';
    ...
    public function entry($to, $data)
    {

        // メールのタイトル
        $subject = "【Will Style Inc.】採用エントリーを受付いたしました。";
        $headers = [];
        // メールのFromアドレス
        $headers[] = "From: Will Style Inc. <hr@willstyle.co.jp>";

        //// 返信先
        $headers[] = 'Reply-To: Will Style Inc. <hr@willstyle.co.jp>';
    ...
    public function cancellation($to, $data)
    {

        // メールのタイトル
        $subject = "【Will Style Inc.】解約申請フォーム送信内容確認メール";
        $headers = [];
        // メールのFromアドレス
        $headers[] = "From: Will Style Inc. <info@willstyle.co.jp>";
