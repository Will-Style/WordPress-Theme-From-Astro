...
$cats = wp_get_object_terms(get_the_ID(), 'blog-cat', ['orderby' => 'term_order', 'order' => 'ASC']);
$cats = is_wp_error($cats) ? [] : $cats;
$corpname = get_field('projects-corpname');
// ヒーロー画像はアイキャッチ。動画設定時はポスター画像にも使う
$thumb_id = get_post_thumbnail_id();

?>

<main id="content" class="lower blog blog-single<?php if($is_project_story){ echo ' project-story'; }?>">
                ...
                <section class="blog-single__hero">
                    ...
                    <dl class="blog-single__details">
                        ...
                        <div class="blog-single__details__col" >
                            <dt class="blog-single__details__dt">Category</dt>
                            <dd class="blog-single__details__dd">
                                <ul class="blog-single__details__list">
                                    <?php foreach($cats as $cat): ?>
                                    <li class="blog-single__details__list__item"><a href="<?php echo esc_url(get_term_link($cat));?>"><span><?php echo esc_html($cat->name);?></span></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </dd>
                        </div>
                        ...
                        <?php 
                            ...
                            $author_id = $author->ID;
                        ?>
                        <div class="blog-single__details__col :author" >
                            <div class="blog__author">
                                <figure class="blog__author__figure">
                                    <picture>
                                        <?php echo get_simple_local_avatar( $author_id , 200 , "" , "アバター画像" ,["class" => "blog__author__icon__figure__image"]);?>
                                    </picture>
                                </figure>
                                <div class="blog__author__content">
                                    <div class="blog__author__position">Author</div>
                                    <div class="blog__author__name"><?php echo get_the_author_meta( 'display_name', $author_id );?></div>
            ...
            <div class="container">
                <div class="pb-60">
                    <div class="blog__body">
                        <?php the_content();?>
                        <?php $related_ids = get_field('related-url');?>
                        <?php if(!empty($related_ids)):?>
                        <?php include ( get_template_directory().'/components/RelatedPosts.php' );?>
                        <?php endif;?>
                    </div>
                </div>
    ...
    <?php include(get_template_directory().'/components/PageNavi.php');?>
